 ...
 * @license MIT
 */
class Doctrine2CacheServiceProvider extends \Illuminate\Support\ServiceProvider
{
    ...
    private function handleConfigs() {
        $configPath = __DIR__ . '/../config/d2cache.php';
        $this->publishes( [ $configPath => config_path('d2cache.php') ] );
